...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* BASE Level: Default Layer
     ...
     |-------+---+---+---+---+---+---+---+---+---+---+-------+-----+-------+---|
              ...
              |------+------+-----------------------+-----+-------|
              | LAlt | LGUI | ******* Space ******* | Meh | Hyper |
              |------+------+-----------------------+-----+-------|

      Meh - C-S-M (control, shift, meta)
      Hyper = C-S-M-s (control, shift, meta, super)
    */
    ...
    [BASE] = LAYOUT( //  default layer
        ...
        KC_LALT, KC_LGUI, /*        */ KC_SPC, KC_MEH, KC_HYPR),
    ...
    /* NOTE(asm,2024-12-12): DON'T OVERRIDE MODIFIERS IN A LAYER! YOU WILL REGRET IT! */
